...
[PublicAPI]
public sealed class GenerateEnumExtensionMethodsAttribute : Attribute
{
  /// <summary>
  ...
  ///   contains default values only. See <see href="#remarks">remarks</see> of this method or documentation on properties of
  ///   this type for details.
  /// </summary>
  /// <returns>
