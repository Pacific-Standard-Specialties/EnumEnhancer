...
namespace PSS.EnumEnhancers.ExtensionMethods.Constants;
...
{
  internal const string AttributesNamespace = $"{EnumEnhancerRootNamespace}.Attributes";

  internal const string AssemblyExtendedEnumTypeAttributeFullName = $"{AttributesNamespace}.{nameof(AssemblyExtendedEnumTypeAttribute)}";

  internal const string DefaultTypeNameSuffix = "Extensions";

  internal const string FallbackClassNamespace = "EnumEnhancers.ExtensionMethods";

  internal const string EnumEnhancerRootNamespace = "PSS.EnumEnhancers.ExtensionMethods";

  private const string NetStandard20CompatibilityNamespace = $"{EnumEnhancerRootNamespace}.Compatibility";
  ...
  internal static class DotnetNames
  {
    ...
    internal static class Attributes
    {
      ...
      internal static class Applications
      {
        ...
        internal const string GeneratedCode = $"""[{Attributes.GeneratedCode}("{EnumEnhancerRootNamespace}","1.0")]""";
  ...
  internal static class Templates
  {
    internal const string AutoGeneratedCommentBlock = $"""
                                                       //------------------------------------------------------------------------------
                                                       // <auto-generated>
                                                       //   This file and the code it contains were generated by a source generator in
                                                       //   the {EnumEnhancerRootNamespace} library.
                                                       //
    ...
    /// <summary>
    ///   A set of explicit type aliases just in case there's a collision.
    /// </summary>
