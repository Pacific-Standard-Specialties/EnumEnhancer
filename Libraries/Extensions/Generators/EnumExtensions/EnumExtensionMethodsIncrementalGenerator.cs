...
{
    private const string ExtensionsForEnumTypeAttributeFullyQualifiedName =
        $"{Strings.AttributesNamespace}.{ExtensionsForEnumTypeAttributeName}";
    ...
    private static void GenerateAttributeSources(
        IncrementalGeneratorPostInitializationContext postInitializationContext)
    {
            ...
            .AddSource(
                ...
                SourceText.From(
                    $$"""
                      ...
                      namespace {{Strings.AttributesNamespace}};
            ...
            .AddSource(
                ...
                SourceText.From(
                    $$"""
                      ...
                      /// </summary>
                      /// <remarks>
                      ///     Properties are just convenient shortcuts to properties of typeof(<typeparamref name="TEnum"/>).
                      /// </remarks>
                      {{Strings.Templates.AttributesForGeneratedTypes}}
